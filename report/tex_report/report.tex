...
This section quickly presents the advancement of the project. The Gantt diagram of figure~\ref{fig:gantt} illustrate the main parts of the project.
...
The last part that I achieved was to convert the OpenPose JSON format to the format used in ST-GCN.
